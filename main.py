...
with tab1:
    ...
    st.session_state.enable_voice = st.selectbox('enable audio', ['no', 'yes'])
...
with tab4:
    ...
    st.session_state.enable_sdxl = st.selectbox('enable sdxl', ['no', 'yes'])
    st.session_state.steps = st.slider('num of steps', 1, 32, 1)
    st.session_state.runs = st.slider('num of runs', 1, 32, 1)
